  ...
  Future<List<dynamic>?> _sendImageToApi(File file) async {
    ...
    try {
      ...
      final options = Options(
        headers: {
          'Authorization':
              'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6ImUyZDdlMWIzLWM0MzUtNDdmZi04NDZhLTUyZjAzNzUwMjRkMCIsImVtYWlsIjoic3VwZXJBZG1pbkBtdGwuY29tIiwicm9sZSI6InN1cGVyX2FkbWluIiwiaWF0IjoxNzQzODk2OTQxLCJleHAiOjE3NDQ1MDE3NDF9._9pFxa6tn600QgPNh5U-maAih9GAtfDeJmcMKAGJJCo',
                          ...
                          Container(
                            ...
                            child: Column(
                              children: [
                                          ...
                                          Navigator.push(
                                            ...
                                            MaterialPageRoute(
                                              builder: (context) => HospitalLocation(
                                                testNames: [_searchController.text],
                                              ),
                                            ),
                                          );
                                        }
                                ...
                                if (_extractedTests != null && _extractedTests!.isNotEmpty)
                                  Padding(
                                ...
                                if (_hospitals != null && _hospitals!.isNotEmpty)
                                Padding(
                                              ...
                                              children: [
                                                ...
                                                Row(
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Text(
                                                        'Turnaround Time: ${hospital['turnaroundTime']}',
                                                        style: GoogleFonts.poppins(
                                                          fontSize: 14,
                                                          color: Colors.black54,
                                                        ),
